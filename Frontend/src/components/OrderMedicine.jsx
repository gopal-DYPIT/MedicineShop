  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br bg-gray-100 px-4 sm:px-6 lg:px-8">
      <div className="w-full max-w-lg space-y-6 p-8 bg-white shadow-xl rounded-lg">
        <h1 className="text-3xl font-bold text-gray-800 text-center">Order Medicine by Prescription</h1>
        ...
        <ul className="list-decimal list-inside space-y-2 text-gray-700 text-sm">
          <li>Select or take a clear picture of your prescription.</li>
          <li>Preview and ensure the document is legible.</li>
          <li>Upload the prescription using the form below.</li>
          <li>Our team will review your order and contact you for confirmation.</li>
        </ul>
        ...
        <p className="text-gray-500 text-xs text-center mt-4">*Only images (.jpg, .jpeg, .png) and PDFs are accepted.</p>
      </div>
    </div>
  );
};
